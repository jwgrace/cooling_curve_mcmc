...
# Set path to directory with neutron star cooling curve functions
...
arguments = ['./run_dStar', '-I', mcmc.inlist, '-L', mcmc.LOGS]+[str(option) for parameter in zip(mcmc.parameter_options, median_parameters) for option in parameter]
